...
Frozen copy of the approved draft. Any substantive change to this
document is a pre-registration violation. The draft file
`bio_preregistration_v1_norman2019.md` may evolve into v2 in the
future; *this* file does not.
...
*Locked 2026-05-04. Tag `bio_prereg_v1_locked`. One-shot. No rescue.*
